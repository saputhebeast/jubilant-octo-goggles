...
if(isset($_SESSION['customer_id']) && isset($_SESSION['first_name']) && isset($_SESSION['last_name'])){
    if (isset($_POST['pay'])) {
        ...
        if ($owner_name !== 'Andrew Perera') {
            ...
            $sql = "INSERT INTO item_order (order_customer_id, order_item_id, order_item_name, order_item_image, order_quantity, order_total_price, address, email, order_status) VALUES ('$_SESSION[order_customer_id]', '$_SESSION[order_item_id]', '$_SESSION[order_item_name]', '$_SESSION[order_item_image]', '$_SESSION[order_quantity]', '$_SESSION[order_total_price]', '$_SESSION[order_address]', '$_SESSION[order_email]', 'Ordered')";
