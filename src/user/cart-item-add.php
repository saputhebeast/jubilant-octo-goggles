...
<?php
        if (isset($_POST['add_to_cart'])){
            ...
            $sql = "INSERT INTO cart (item_id, cart_item_type, cart_item_brand, cart_item_model, cart_item_image, cart_item_quantity, cart_item_price) 
VALUES ('$item_id', '$item_type', '$item_brand', '$item_model', '$item_image', '$item_quantity', '$item_price');";
